...
public class Main {
    ...
    public static void animal(){
        ...
        Cow cow1 = new Cow(233,4,"female","Avrora");
        Cow cow2 = new Cow(200,2,"female","Avgustina");
        ...
        Horse horse1 = new Horse(100,1,"female","Arfa");
        Horse[] horses = {horse,horse1};
        Horse[] horse2 = {horse};
        Sheep sheep = new Sheep(50,2,"male","Megamisha");
        Sheep sheep1 = new Sheep(40,2,"female","Bogataya");
